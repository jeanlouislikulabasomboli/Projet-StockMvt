...
function mettreAJourIndicateurCloud() {
    const elementCloud = document.querySelector('.menu-item .menu-item-droite span[style*="succes"]');
    // Chercher plus précisément l'élément Cloud dans le menu
    const itemsMenu = document.querySelectorAll('.menu-item');
    itemsMenu.forEach(item => {
        const texte = item.querySelector('.menu-item-texte');
        if (texte && texte.textContent.trim() === 'Cloud') {
            const indicateur = item.querySelector('.menu-item-droite span');
            if (indicateur) {
                if (navigator.onLine) {
                    if (synchronisationEnCours) {
                        indicateur.textContent = 'Synchronisation...';
                        indicateur.style.color = 'var(--attention)';
                    } else {
                        indicateur.textContent = 'Synchronisé';
                        indicateur.style.color = 'var(--succes)';
                    }
                } else {
                    indicateur.textContent = 'Hors-ligne';
...
async function executerModifierProduit() {
    ...
    try {
        ...
        console.log("Produit modifié :", data);
                ...
                afficherMessageSucces("Produit modifié avec succès.");
