...
async function creerProfilSiInexistant(utilisateur) {
    ...
    const nouveauProfil = {
    id: utilisateur.id,
    nom_complet: obtenirNomUtilisateurDepuisAuth(utilisateur),
    email: utilisateur.email,
    photo_url: obtenirPhotoUtilisateurDepuisAuth(utilisateur),
    entreprise_active_id: null
};

const { data: profilCree, error: erreurCreation } = await clientSupabase
    .from("profils")
...
if (erreurCreation) {
    console.error("Erreur création profil :", erreurCreation);
